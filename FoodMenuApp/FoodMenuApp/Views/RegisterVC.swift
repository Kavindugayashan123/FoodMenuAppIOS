...
class RegisterVC: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        setupViews()
        setupConstraints()
        [firstnameInput,passwordInput,emailInput,phoneInput].forEach {
            $0.delegate = self
        }
    ...
    @objc func registerClick(){
        ...
        self.controller.registerUser(email: emailInput.text!, password: passwordInput.text!, name: firstnameInput.text!, phone: phoneInput.text!) {(success) in
            if(success){
    ...
    @objc func hideKeyboard(){
        [firstnameInput,passwordInput,emailInput].forEach { item in
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        if firstnameInput.isFirstResponder{
            ...
            [emailInput,firstnameInput].forEach {
                $0.removeBorders()
            }
        }
    }
